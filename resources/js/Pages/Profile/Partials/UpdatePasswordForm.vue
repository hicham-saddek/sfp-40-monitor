<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Assurer vous que votre compte utilise un mot de passe long et aléatoire pour mieux assurer votre sécurité.
        </template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" value="Confirmer votre nouveau mot de passe" />
